...
#Method for opening training results window
    def opentrainresults(self):
        ...
        self.ui.glcmgb.setText(str(accuracies[2]))
        self.ui.lbglcmgb.setText(str(accuracies[3]))
        self.ui.cnn.setText(str(accuracies[4]))
        self.window.show()
...
#Defining setup and other methods
    def setupUi(self, Dialog):
        ...
        self.label_10.setGeometry(QtCore.QRect(30, 280, 400, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.label_24.setGeometry(QtCore.QRect(30, 510, 400, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
...
#Setting button actions for displaying training result
        ...
        self.displaytrainres.setGeometry(QtCore.QRect(450, 720, 181, 51))
        ...
        self.displaytrainres.clicked.connect(self.RandomTrees_GLCM)
        self.displaytrainres.clicked.connect(self.RandomTrees_LBGLCM)
        # self.displaytrainres.clicked.connect(self.ExtraTrees_GLCM)
        # self.displaytrainres.clicked.connect(self.ExtraTrees_LBGLCM)
        self.displaytrainres.clicked.connect(self.GB_GLCM)
        self.displaytrainres.clicked.connect(self.GB_LBGLCM)
        self.displaytrainres.clicked.connect(self.CNN)
...
#Setting button actions for proceeding to operator window
        ...
        self.Proceedtoclass.setGeometry(QtCore.QRect(700, 720, 221, 51))
...
#Setting up the layouts
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(140, 30, 581, 41))
        ...
        self.DistanceforGLCM.setText("1")
        self.gridLayout.addWidget(self.DistanceforGLCM, 2, 1, 1, 1)
        self.layoutWidget2 = QtWidgets.QWidget(Dialog)

        self.layoutWidget2.setGeometry(QtCore.QRect(450, 130, 401, 121))
        ...
        self.RadiusforLBGLCM.setText("1")
        ...
        self.DistanceforLBGLCM.setText("1")
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(450, 350, 301, 121))
        ...
        self.Estimators_gb.setText("100")
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(40, 500, 291, 171))
        ...
        self.gridLayout_7.addWidget(self.label_21, 0, 0, 0, 0)
        ...
        self.validation_split.setText("0.2")
        ...
        self.topBrowseHorizLine.setGeometry(QtCore.QRect(20, 10, 901, 21))
        ...
        self.bottomBrowseHorizLine.setGeometry(QtCore.QRect(20, 70, 901, 21))
        ...
        self.bottomFEHorizLine.setGeometry(QtCore.QRect(20, 270, 901, 16))
        ...
        self.bottomClassifierHorizLine.setGeometry(QtCore.QRect(20, 500, 901, 21))
        ...
        self.windowLeftVertLine.setGeometry(QtCore.QRect(3, 20, 31, 690))
        ...
        self.windowRightVertLine.setGeometry(QtCore.QRect(901, 20, 41, 690))
        ...
        self.bottomCNNHorizLine.setGeometry(QtCore.QRect(20, 700, 901, 21))
...
#Setting up the logo for GUI
        Dialog.setWindowTitle(_translate("Dialog", "Training"))
...
#Setting other text box labels
        ...
        self.label_10.setText(_translate("Dialog", "Machine Learning Algorithms"))
        self.label_24.setText(_translate("Dialog", "Deep Learning"))
