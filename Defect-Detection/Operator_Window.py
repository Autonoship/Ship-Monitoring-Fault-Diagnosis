...
#Method for setting up the UI
    def setupUi(self, Dialog2):
        ...
        Dialog2.resize(592, 300)
        self.comboBox = QtWidgets.QComboBox(Dialog2)
        self.comboBox.setGeometry(QtCore.QRect(150, 125, 291, 41))
        font = QtGui.QFont()
...
#Setting up button action for classifying image
        ...
        self.Classify.setGeometry(QtCore.QRect(230, 220, 121, 41))
...
#Setting up layout
    ...
    def retranslateUi(self, Dialog2):
        ...
        Dialog2.setWindowTitle(_translate("Dialog2", "Testing"))
        ...
        self.comboBox.setItemText(2, _translate("Dialog2", "GLCM + Gradient Boosting"))
        self.comboBox.setItemText(3, _translate("Dialog2", "LBGLCM + Gradient Boosting"))
        self.comboBox.setItemText(4, _translate("Dialog2", "Convolutional Neural Networks"))
